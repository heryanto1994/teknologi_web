...
<tr>
    ...
    <tr>    
        ...
        <td>
            <a class="btn btn-default" href="hapus.php"<?php echo $row['id'];?>>Edit</a>
            <a class="btn btn-alert" onclick="return confirm('Yakin akan menghapus data?');" href="?mod=admin/hapus&id"<?php echo $row['id']; ?>">Delete</a>
        </td>
    </tr>
    <?php endwhile; ?>
